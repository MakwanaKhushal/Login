        ...
        <form class="was-validated">
            <div class="main-user-info">
                <div class="user-input-box">
                    ...
                    <input type="text" id="fullName" name="fullName" placeholder="Enter Full Name"  v-model="Title" required />
                ...
                <div class="user-input-box">
                    <label for="email">User<span style="color:red;">*</span></label>
                      <Multiselect style="margin-left:0;width:564px;border:1px solid ;" v-model="User"
                        :options="useroptions" placeholder="select opation" :closeOnSelect="true" :clearOnSelect="true"  class="w-[11rem]">
                    </Multiselect> &nbsp;
                ...
                <div class="user-input-box">
                    <label for="phoneNumber">Tag<span style="color:red;">*</span></label>
                      <Multiselect style="margin-left:22px;width:564px;border:1px solid ;" v-model="tag" object  :options="tagoptions" placeholder="select opation" :closeOnSelect="true" :clearOnSelect="true" :searchable="true" mode="tags" :multiple="true" class="w-[11rem]">
                    </Multiselect>&nbsp;
                ...
                <div class="user-input-box">
                    <label for="password">Categories<span style="color:red;">*</span></label>
                      ...
                      v-model="categore"  :options="categoreoptions" placeholder="select opation" :closeOnSelect="true" :clearOnSelect="true"   class="w-[11rem]">
                    </Multiselect>
                ...
                <div class="user-input-box">
                   ...
                   <div class="user-input-box">
                    ...
                    <input type="text" id="password" name="password" placeholder="Enter Password" v-model="status" />
                    <h5 style="color: red">{{ error.status }}</h5>
                </div>
                   <div class="user-input-box">
                    <label for="password">Image<span style="color:red;">*</span></label>
                     
                    <input type="file" id="password" name="password" placeholder="Enter Password" @change="addImage" />
            ...
            <div class="form-submit-btn ">
                <button class="btn btn-info" @click.prevent="storeblog">
                    Update
                </button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
const getblog =()=>{
    ...
    axios.get(`https://blog-api-dev.octalinfotech.com/api/blogs/${route.params.id}/show`, {
        ...
        .then((res) => {
                ...
                tag.value=res.data.data.tag.map((tag) => {return {label: tag.name, value: tag.id}})
        })
        .catch((error) => {
            console.log(error);
        })
